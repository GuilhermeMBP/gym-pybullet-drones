...
DEFAULT_ACT = ActionType('discrete_2d_complex') #add a new action configuration to include 25 descrete actions
DEFAULT_AGENTS = 2
DEFAULT_MA = False
...
def run(multiagent=DEFAULT_MA, 
    ...
    #add a new algorithm and specific configurations for a model construction
    model = SAC('MlpPolicy',
                train_env,
                learning_rate=learning_rate,
                gamma=gamma,
